...
GO
/*
The column [dbo].[Games].[%GG] is being dropped, data loss could occur.

The column [dbo].[Games].[%Over25] is being dropped, data loss could occur.
*/
