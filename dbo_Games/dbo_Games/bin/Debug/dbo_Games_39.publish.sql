...
GO
/*
The type for column Coeff in table [dbo].[Games] is currently  DECIMAL (18, 4) NULL but is being changed to  DECIMAL (18, 2) NULL. Data loss could occur.
*/
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Games] ([Id], [Date], [Time], [Game], [Bet], [Result], [Val1], [Val2], [Val3], [Val4], [ValB1], [ValB2], [ValB3], [ValB4], [Sval1], [Sval2], [Sval3], [Sval4], [SvalB1], [SvalB2], [SvalB3], [SvalB4], [Fval1], [Fval2], [Fval3], [Fval4], [FvalB1], [FvalB2], [FvalB3], [FvalB4], [F8val1], [F8val2], [F8val3], [F8val4], [F8valB1], [F8valB2], [F8valB3], [F8valB4], [Coeff])
        SELECT   [Id],
                 [Date],
                 [Time],
                 [Game],
